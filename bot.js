  ...
  if (message.author.equals(bot.user)) return;
     ...
     if(message.content ===("باك")){
       ...
       message.channel.send('**تيت آلُِلُِهـ معٍڪ يحٍلُِوُ لُِآ تطُوُلُِ عٍلُِينآ**');
           ...
           if(message.content ===("!")){
              message.channel.send('**-҉ W̘̩̤elco̟mẹ͎ͅ To Kni͕̰͡g͎͇hts ̽̈͒Of͑͛͌ ͉͇ͅDark̍̌̅ness**');
                                     }
           if(message.content ===("..")){
           ...
           if(message.content ===(".")){
              message.channel.send('**آطٌُلَُِقٌَ مِنٌ يّنٌقٌَطٌُ, وُلُِلُِڪم , ء منوُرٍ**');

                                                                           }
           if(message.content ===("...")){
              message.channel.send('**خـلُِآآص ملُِيت منڪ**');


                                                          }
           if(message.content ===("الرابط")){
              message.channel.send('**https://discord.gg/kFAzFHj**');
                                                 }
           if(message.content ===("الشعار")){
              message.channel.send('**[ ! KD, ] : شعارك بالديسكورد [ !ᵏᵈを ] :شعارك باللعبه**');
